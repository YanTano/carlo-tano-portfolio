...
/* ============ CARLO Assistant — Chat Engine ============ */
(function(){
  /* ------------------------------------------------------------
     Carlo Assistant runs fully client-side on a local knowledge base
  ...
  function getResponse(rawQuery){
    ...
    if(has('hello','hi ','hey','good morning','good afternoon','yo') || q.trim()==='hi' || q.trim()==='hey') return {
      text: `Hey! 👋 I'm **Carlo Assistant** — ask me about his QA experience, skills, projects, or how to get in touch.`,
